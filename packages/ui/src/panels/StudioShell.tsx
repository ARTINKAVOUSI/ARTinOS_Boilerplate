...
import { ComponentDevToolsPanel } from '../devtools'
...
export function StudioShell({ viewport, variant = 'metablock' }: { viewport: ReactNode; variant?: 'panels' | 'metablock' }) {
  ...
  return engine === 'metablock'
    ...
    : <PanelWorkspace panels={panels} viewport={viewport} persistKey="artinos.studio.panels-v5" statusOverlay={<ConsoleToast />} />
}
